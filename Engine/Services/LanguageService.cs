    ...
    public class LanguageService : INotifyPropertyChanged
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new Dictionary<string, Dictionary<string, string>>
        {
            { "EN", new Dictionary<string, string> {
                ...
                { "LogDestLocal", "Local only" },
                { "LogDestServer", "Server only" },
                { "LogDestBoth", "Local and Server" },
                ...
                { "MsgSoftwarePause", "PAUSE (Business software) :" },
                { "MsgBlockedSize", "BLOCKED (Size limit exceeded by) :" },
                { "MsgWaitingCrypto", "WAITING (Simultaneous encryption limited)" },
                { "MsgResume", "RESUME" },
                ...
                { "LangFR", "French" },
                { "LangEN", "English" },
                { "LblPauseBehavior", "Pause Behavior:" },
                { "PauseImmediate", "Immediate" },
                { "PauseAfterFile", "After current file finishes" },
                ...
                { "ProcessTabTitle", "Other user's saves" },
            ...
            { "FR", new Dictionary<string, string> {
                ...
                { "BtnRun", "Lancer" },
                { "BtnDelete", "Supprimer" },
                { "BtnPauseAll", "Pause Tout" },
                { "BtnResumeAll", "Reprendre Tout" },
                { "BtnStopAll", "Arrêter Tout" },
                { "Settings", "⚙ Paramètres" },
                { "Close", "Fermer" },
                ...
                { "LogDestLocal", "Local uniquement" },
                { "LogDestServer", "Serveur uniquement" },
                { "LogDestBoth", "Local et Serveur" },
                ...
                { "MsgSoftwarePause", "PAUSE (Logiciel métier) :" },
                { "MsgBlockedSize", "BLOQUÉ (Limite de taille dépassée par) :" },
                { "MsgWaitingCrypto", "EN ATTENTE (Chiffrement simultané limité)" },
                { "MsgResume", "REPRISE" },
                ...
                { "LangFR", "Français" },
                { "LangEN", "Anglais" },
                { "LblPauseBehavior", "Comportement de la pause :" },
                { "PauseImmediate", "Immédiate" },
                { "PauseAfterFile", "Après le fichier en cours" },
                { "TitleNetwork", "🌐 Réseau" },
                ...
                { "ProcessTabTitle", "Sauvegardes d'autres utilisateurs" },
